...
maior = max(numero_um, numero_dois) #Max: escolhe o maior valor entre as variaveis dentro dos parenteses
menor = min(numero_um, numero_dois) #Min: escolhe o menor valor entre as variaveis dentro dos parenteses
